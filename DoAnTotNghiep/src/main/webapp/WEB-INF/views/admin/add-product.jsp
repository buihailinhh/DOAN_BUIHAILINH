...
<link rel="icon" type="image/png" sizes="16x16"
	href="${rootpath}/admin/assets/images/favicon.png">
						...
						<div class="d-flex align-items-center">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb m-0 p-0">
									<li class="breadcrumb-item"><a href="${rootpath }home"
			...
			<div class="container-fluid">
                ...
                <div class="row">
                	<div class="col-12">
	                    <div class="card">
	                        <div class="card-body">
	                        	<sf:form class="form" action="${classpath}/manager/save-add-product" method="post" modelAttribute="product" enctype="multipart/form-data">
	                        		 ...
	                        		 <div class="form-body">
										...
										<div class="row">
	                                    	...
	                                    	<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="discount" type="number" autocomplete="off" id="discount" name="discount" class="form-control" placeholder="Sale price"></sf:input>
                                        		</div>
	                                    	</div>
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        <label for="productImages">Choose product Image</label>
                                    				<input id="productImages" name="productImages" type="file" class="form-control-file" multiple="multiple" >
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        <a href="${classpath }/manager/list-product/1" class="btn btn-secondary active" role="button" aria-pressed="true">
			                                        	Back to list
			                                        </a>
