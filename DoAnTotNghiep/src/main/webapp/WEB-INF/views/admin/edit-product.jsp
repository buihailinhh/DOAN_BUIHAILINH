			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-7 align-self-center">
						<h4
							class="page-title text-truncate text-dark font-weight-medium mb-1">Edit product</h4>
	                        	...
	                        	<sf:form class="form" action="${classpath}/manager/save-edit-product" method="post" modelAttribute="product" enctype="multipart/form-data">
	                        		 ...
	                        		 <div class="form-body">
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        <label for="productPicture">Choose product Image</label>
                                    				<input id="productPicture" name="productPicture" type="file" class="form-control-file" multiple="multiple" >
                                        		</div>
	                                    	</div>
										</div>
