...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="${rootpath}/admin/assets/images/favicon.png">
                ...
                <!-- basic table -->
               	<div class="row">
                	<div class="col-12">
	                    <div class="card">
	                        <div class="card-body">
	                        	<sf:form class="form" action="${classpath}/manager/save-edit-category" method="post" modelAttribute="category" enctype="multipart/form-data">
	                        		 <div class="form-body">
	                        			<div class="row">
	                        		 		<div class="col-md-6">
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="createDate" class="form-control" type="date" 
			                                        			id="createDate" name="createDate" value="2023-7-14"></sf:input>
                                        		</div>
	                                    	</div>
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="updateDate" class="form-control" type="date" 
			                                        			id="updateDate" name="updateDate" value="2023-7-14"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        <a href="${classpath }/manager/list-category" class="btn btn-secondary active" role="button" aria-pressed="true">
			                                        	Back to list
			                                        </a>
